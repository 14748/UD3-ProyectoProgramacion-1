...
Public Class Diccionario
    ...
    Public Function GetRandomWord(dificultad As Integer) As Palabra
        ...
        If palabrasPosibles.Count = 0 Then
            Return Nothing
        Else
    ...
    Public Function Igual(pal As Palabra, dif As Integer)
        Dim rndPal As Palabra
        rndPal = New Palabra(GetRandomWord(dif).Texto, GetRandomWord(dif).Dificultad, GetRandomWord(dif).NumeroLetras)
        If pal.Texto = rndPal.Texto Then
            Return True
        Else
            Return False
        End If
